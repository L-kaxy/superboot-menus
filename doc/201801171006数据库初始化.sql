...
CREATE TABLE `t_menu` (
  `menuid` bigint(16) NOT NULL AUTO_INCREMENT COMMENT '菜单编号',
...
insert  into `t_menu`(`menuid`,`menuname`,`createtime`,`creatorid`,`editetime`,`editorid`,`isdelete`,`islockup`,`version`) values (1,'SuperAdmin','2017-11-15 09:49:41',1,'2017-11-15 09:49:41',NULL,0,0,0);

/*Table structure for table `t_menuitem` */

DROP TABLE IF EXISTS `t_menuitem`;

CREATE TABLE `t_menuitem` (
  `menuitemid` bigint(16) NOT NULL AUTO_INCREMENT COMMENT '菜单项编号',
  `menuid` bigint(16) NOT NULL COMMENT '菜单编号',
  `menuitemname` varchar(64) NOT NULL COMMENT '菜单项标题',
  `menuitemicon` varchar(64) DEFAULT NULL COMMENT '菜单项图标',
  `menuitemorder` bigint(16) DEFAULT '0' COMMENT '菜单项排序',
  `menuitemurl` varchar(64) DEFAULT NULL COMMENT '菜单项地址',
  `menuitemrouteurl` varchar(64) DEFAULT '#' COMMENT '菜单项路由地址',
  `menuitemctrl` varchar(64) DEFAULT NULL COMMENT '菜单项控制器',
  `menuitemparentid` bigint(16) DEFAULT '0' COMMENT '菜单项父菜单项编号',
  ...
  KEY `t_menuitem_ibfk_1` (`menuid`),
  CONSTRAINT `t_menuitem_ibfk_1` FOREIGN KEY (`menuid`) REFERENCES `t_menu` (`menuid`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8;

/*Data for the table `t_menuitem` */

insert  into `t_menuitem`(`menuitemid`,`menuid`,`menuitemname`,`menuitemicon`,`menuitemorder`,`menuitemurl`,`menuitemrouteurl`,`menuitemctrl`,`menuitemparentid`,`isshow`,`createtime`,`creatorid`,`editetime`,`editorid`,`isdelete`,`islockup`,`version`) values (1,1,'权限管理','fa fa-vimeo-square',0,NULL,'#',NULL,0,1,'2017-11-15 09:49:42',1,'2017-11-15 09:49:42',1,0,0,2),(2,1,'资源管理','fa fa-globe',1,NULL,'#',NULL,0,1,'2017-11-15 09:49:42',1,'2017-11-15 09:49:42',1,0,0,1),(3,1,'授权管理',NULL,0,'userkey/userkeylist.html','#/userkeylist','userkeylist',1,1,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,2),(4,1,'用户角色分配',NULL,0,'userkey/userkeyrole.html','#/userkeyrole','userkeyrole',3,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(5,1,'角色管理',NULL,1,'role/rolelist.html','#/rolelist','rolelist',1,1,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,2),(6,1,'添加角色',NULL,0,'role/addrole.html','#/addrole','addrole',5,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(7,1,'编辑角色',NULL,1,'role/editrole.html','#/editrole','editrole',5,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(8,1,'行为管理',NULL,2,'permission/permissionlist.html','#/permissionlist','permissionlist',1,1,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(9,1,'添加行为',NULL,0,'permission/addpermission.html','#/addpermission','addpermission',8,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(10,1,'编辑行为',NULL,1,'permission/editpermission.html','#/editpermission','editpermission',8,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(11,1,'接口管理',NULL,0,'action/actionlist.html','#/action','actionlist',2,1,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(12,1,'添加接口',NULL,0,'action/addaction.html','#/addaction','addaction',11,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(13,1,'编辑接口',NULL,1,'action/editaction.html','#/editaction','editaction',11,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(14,1,'菜单管理',NULL,1,'menu/menulist.html','#/menu','menulist',2,1,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(15,1,'添加菜单',NULL,0,'menu/addmenu.html','#/addmenu','addmenu',14,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(16,1,'编辑菜单',NULL,1,'menu/editmenu.html','#/editmenu','editmenu',14,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(17,1,'菜单项管理',NULL,2,'menuitem/menuitemlist.html','#/menuitemlist','menuitemlist',14,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(18,1,'添加菜单项',NULL,3,'menuitem/addmenuitem.html','#/addmenuitem','addmenuitem',14,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1),(19,1,'编辑菜单项',NULL,4,'menuitem/editmenuitem.html','#/editmenuitem','editmenuitem',14,0,'2017-11-15 09:56:46',1,'2017-11-15 09:56:46',1,0,0,1);
